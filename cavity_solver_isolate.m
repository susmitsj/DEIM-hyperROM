function [sol_p, sol_u, sol_v, rhs_p, rhs_u, rhs_v, conv] = cavity_solver_isolate(uinf, rho, imax, jmax, imms, isgs, u)
...
for n = ninit:nmax
    % Calculate time step
    dtmin = compute_time_step(dtmin, imax, jmax, rho, u);
    ...
    if isgs==1 % ==Symmetric Gauss Seidel==
        ...
        Compute_Artificial_Viscosity(imax, jmax, rho, u);
        
        % Symmetric Gauss-Siedel: Forward Sweep
        u = SGS_forward_sweep(imax, jmax, rho, u);
        ...
        u = SGS_backward_sweep(imax, jmax, rho, u);
    ...
    u = pressure_rescaling(imax, jmax, imms, u);
    
    % Update the time
    rtime = rtime + dtmin;
    
    % Check iterative convergence using L2 norms of iterative residuals
    [res, resinit, conv] = check_iterative_convergence(n, res, resinit, imax, jmax, u);
...
%************************************************************************
function dtmin = compute_time_step(dtmin, imax, jmax, rho, u)
...
%************************************************************************
function Compute_Artificial_Viscosity(imax, jmax, rho, u)
%
...
%************************************************************************
function u = SGS_forward_sweep(imax, jmax, rho, u)
%
...
%************************************************************************
function u = SGS_backward_sweep(imax, jmax, rho, u)
%
%Uses global variable(s): two, three, six, half
%Uses global variable(s): imax, imax, jmax, ipgorder, rho, rhoinv, dx, dy, rkappa, ...
%                      xmax, xmin, ymax, ymin, rmu, vel2ref
...
%************************************************************************
function u = point_Jacobi(imax, jmax, rho)
%
%Uses global variable(s): two, three, six, half
%Uses global variable(s): imax, imax, jmax, ipgorder, rho, rhoinv, dx, dy, rkappa, ...
%                      xmax, xmin, ymax, ymin, rmu, vel2ref
...
%************************************************************************
function u = pressure_rescaling(imax, jmax, imms, u)
%
